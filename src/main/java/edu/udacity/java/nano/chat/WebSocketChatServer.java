...
public class WebSocketChatServer {
    ...
    public void onOpen(Session session, @PathParam("username") String username) throws IOException {
        ...
        Message message = new Message(username, username + " joined the chat", onlineSessions.size(), Message.MessageType.ENTER);
    ...
    public void onClose(Session session) throws IOException {
        ...
        Message message = new Message(username, username + " left the chat", onlineSessions.size(), Message.MessageType.LEAVE);
        sendMessageToAll(JSON.toJSONString(message));
    ...
    public void onError(Session session, Throwable error) {
        error.printStackTrace();
         System.out.println( "Session ID: "+ session.getId() +
                 " Open sessions:" + session.getOpenSessions().toString());
    }
